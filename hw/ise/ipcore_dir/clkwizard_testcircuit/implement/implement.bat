...
xst -ifn xst.scr
move clkwizard_testcircuit_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkwizard_testcircuit_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkwizard_testcircuit_exdes.ucf clkwizard_testcircuit_exdes

echo 'Running map'
map -timing -pr b clkwizard_testcircuit_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkwizard_testcircuit_exdes -w routed.ncd routed.vhd
cd ..

...
xst -ifn xst.scr
move clkwizard_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkwizard_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkwizard_exdes.ucf clkwizard_exdes

echo 'Running map'
map -timing -pr b clkwizard_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkwizard_exdes -w routed.ncd routed.vhd
cd ..
